...
/**
 * A link that reloads attribute tree on click.
 * 
 * @author Vojtěch Hordějčuk
 */
public class ReloadAttributesLink extends Link<Object> {
    /**
     ...
     * component ID
     */
    public ReloadAttributesLink(final String id) {
        super(id);
    }
    ...
    public void onClick() {
        ...
        try {
            ...
            this.info("Atributy a indexy byly znovu načteny.");
