 ...
 * Attribute add form.
 */
public class AddAttributeForm extends Form<Object> {
    /**
     ...
     * component ID
     */
    public AddAttributeForm(final String id) {
        super(id);
        ...
        final DropDownChoice<Tuple<String, AttributePrototype>> select = new DropDownChoice<Tuple<String, AttributePrototype>>(
                "select",
                this.attribute,
                SimpleAttributeUtils.gatherToList(this.root, true),
    ...
    protected void onSubmit() {
        ...
        try {
            ...
            final CardModification modification = new AddAttributeModification(
                    this.root,
